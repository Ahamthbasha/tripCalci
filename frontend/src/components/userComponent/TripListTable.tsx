          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-3">
            ...
            {selectedCount > 0 && (
              <div className="flex flex-wrap gap-2 justify-center sm:justify-end">
                <button
                  onClick={() => setDeleteModalOpen(true)}
                  className="px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition flex items-center justify-center gap-2 min-w-[100px]"
                >
                  <Trash2 size={16} />
                  Delete
                </button>
                ...
                {selectedCount === 1 && (
                  <button
                    onClick={() => setOpenModalOpen(true)}
                    className="px-4 py-2 bg-gray-700 text-white rounded-lg hover:bg-gray-800 transition flex items-center justify-center gap-2 min-w-[100px]"
                  >
                    <ArrowRight size={16} />
                    Open
                  </button>
                ...
                {selectedCount > 1 && (
                  <button
                    onClick={handleViewSelected}
                    className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition flex items-center justify-center gap-2 min-w-[140px]"
                  >
                    <MapPin size={16} />
                    View Selected
                  </button>
